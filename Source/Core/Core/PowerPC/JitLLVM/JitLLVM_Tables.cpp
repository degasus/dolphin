...
void JitLLVM::DynaRunTable4(LLVMFunction* func, UGeckoInstruction _inst)
{
  (this->*dynaOpTable4[_inst.SUBOP10])(func, _inst);
}
void JitLLVM::DynaRunTable19(LLVMFunction* func, UGeckoInstruction _inst)
{
  (this->*dynaOpTable19[_inst.SUBOP10])(func, _inst);
}
void JitLLVM::DynaRunTable31(LLVMFunction* func, UGeckoInstruction _inst)
{
  (this->*dynaOpTable31[_inst.SUBOP10])(func, _inst);
}
void JitLLVM::DynaRunTable59(LLVMFunction* func, UGeckoInstruction _inst)
{
  (this->*dynaOpTable59[_inst.SUBOP5])(func, _inst);
}
void JitLLVM::DynaRunTable63(LLVMFunction* func, UGeckoInstruction _inst)
{
  (this->*dynaOpTable63[_inst.SUBOP10])(func, _inst);
}
