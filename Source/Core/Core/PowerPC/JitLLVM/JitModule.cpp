...
static Type* GeneratePPCState()
{
  ...
  std::vector<Type*> struct_values = {
      ...
      ArrayType::get(ArrayType::get(llvm_f64, 32), 2),  // PS
...
LLVMModule::LLVMModule(ExecutionEngine* engine, u32 address) : m_engine(engine), m_address(address)
{
  LLVMContext& con = getGlobalContext();
...
void LLVMModule::GenerateGlobalVariables()
{
  ...
  Constant* dequantize_constant =
      ConstantArray::get(ArrayType::get(Type::getFloatTy(con), 64), dequantize_values);
  Constant* quantize_constant =
      ConstantArray::get(ArrayType::get(Type::getFloatTy(con), 64), quantize_values);
  ...
  /* Constants */
  // PowerPCState
  Constant* const_ppcstate_val =
      ConstantInt::getIntegerValue(ppcStatePtr, APInt(64, (uint64_t)&PowerPC::ppcState));
  ...
  // Memory base
  Constant* const_memory_val = ConstantInt::getIntegerValue(
      Type::getInt8PtrTy(con), APInt(64, (uint64_t)Memory::physical_base));
  ...
  // Gather Pipe
  Constant* const_gatherpipe_count = ConstantInt::getIntegerValue(
      Type::getInt32PtrTy(con), APInt(64, (uint64_t)&GPFifo::m_gatherPipeCount));
  ...
  Constant* const_gatherpipe = ConstantInt::getIntegerValue(
      Type::getInt8PtrTy(con), APInt(64, (uint64_t)&GPFifo::m_gatherPipe));
...
void LLVMModule::BindGlobalFunctions()
{
  ...
  Function* dispatcher_func =
      Function::Create(void_type, Function::ExternalLinkage, "Dispatcher", m_mod);
  ...
  {
    FunctionType* type = GenerateFunctionType(Type::getVoidTy(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::CheckExceptions", m_mod);
  ...
  // Read_U64
  {
    FunctionType* type = GenerateFunctionType(Type::getInt64Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Read_U64", m_mod);
    bound_func->setCallingConv(CallingConv::C);
    m_binder->Bind(bound_func, (void*)PowerPC::Read_U64);
  }
  // Read_U32
  {
    FunctionType* type = GenerateFunctionType(Type::getInt32Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Read_U32", m_mod);
    bound_func->setCallingConv(CallingConv::C);
    m_binder->Bind(bound_func, (void*)PowerPC::Read_U32);
  }
  // Read_U16
  {
    FunctionType* type = GenerateFunctionType(Type::getInt16Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Read_U16", m_mod);
    bound_func->setCallingConv(CallingConv::C);
    m_binder->Bind(bound_func, (void*)PowerPC::Read_U16);
  }
  // Read_U8
  {
    FunctionType* type = GenerateFunctionType(Type::getInt8Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Read_U8", m_mod);
    bound_func->setCallingConv(CallingConv::C);
  ...
  {
    FunctionType* type =
        GenerateFunctionType(Type::getVoidTy(con), Type::getInt64Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Write_U64", m_mod);
    bound_func->setCallingConv(CallingConv::C);
  ...
  {
    FunctionType* type =
        GenerateFunctionType(Type::getVoidTy(con), Type::getInt32Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Write_U32", m_mod);
    bound_func->setCallingConv(CallingConv::C);
  ...
  {
    FunctionType* type =
        GenerateFunctionType(Type::getVoidTy(con), Type::getInt16Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Write_U16", m_mod);
    bound_func->setCallingConv(CallingConv::C);
  ...
  {
    FunctionType* type =
        GenerateFunctionType(Type::getVoidTy(con), Type::getInt8Ty(con), Type::getInt32Ty(con));

    Function* bound_func =
        Function::Create(type, Function::ExternalLinkage, "PowerPC::Write_U8", m_mod);
    bound_func->setCallingConv(CallingConv::C);
...
void LLVMModule::GeneratePairedLoadFunction()
{
  ...
  FunctionType* main_type = GenerateFunctionType(ret_type,                // returns <2 x float>
  ...
  builder->SetInsertPoint(float_case);
  {
    ...
    Value* final_res =
        builder->CreateInsertElement(ret_values, res0, builder->getInt32(0), "float_res");
  ...
  builder->SetInsertPoint(u8_case);
  {
    ...
    Value* final_res =
        builder->CreateInsertElement(ret_values, res0, builder->getInt32(0), "u8_res");
    Value* cmp_val = builder->CreateICmpEQ(args[0], builder->getInt8(1));
    builder->CreateCondBr(cmp_val, u8_pair_case, ending_block);

    builder->SetInsertPoint(u8_pair_case);
    Value* res1 =
        CreateReadU8(m_paired_load, builder->CreateAdd(args[3], builder->getInt32(1)), false);
  ...
  builder->SetInsertPoint(u16_case);
  {
    ...
    res0 = builder->CreateFMul(res0, dequantize_value);
    Value* final_res =
        builder->CreateInsertElement(ret_values, res0, builder->getInt32(0), "u16_res");
    Value* cmp_val = builder->CreateICmpEQ(args[0], builder->getInt8(1));
    builder->CreateCondBr(cmp_val, u16_pair_case, ending_block);

    builder->SetInsertPoint(u16_pair_case);
    Value* res1 =
        CreateReadU16(m_paired_load, builder->CreateAdd(args[3], builder->getInt32(2)), false);
    res1 = builder->CreateUIToFP(res1, builder->getFloatTy());
    res1 = builder->CreateFMul(res1, dequantize_value);
    Value* final_paired_res = builder->CreateInsertElement(final_res, res1, builder->getInt32(1));
    builder->CreateBr(ending_block);
  ...
  builder->SetInsertPoint(s8_case);
  {
    ...
    res0 = builder->CreateFMul(res0, dequantize_value);
    Value* final_res =
        builder->CreateInsertElement(ret_values, res0, builder->getInt32(0), "s8_res");
    Value* cmp_val = builder->CreateICmpEQ(args[0], builder->getInt8(1));
    builder->CreateCondBr(cmp_val, s8_pair_case, ending_block);

    builder->SetInsertPoint(s8_pair_case);
    Value* res1 =
        CreateReadU8(m_paired_load, builder->CreateAdd(args[3], builder->getInt32(1)), true);
  ...
  builder->SetInsertPoint(s16_case);
  {
    ...
    res0 = builder->CreateFMul(res0, dequantize_value);
    Value* final_res =
        builder->CreateInsertElement(ret_values, res0, builder->getInt32(0), "s16_res");
    Value* cmp_val = builder->CreateICmpEQ(args[0], builder->getInt8(1));
    builder->CreateCondBr(cmp_val, s16_pair_case, ending_block);

    builder->SetInsertPoint(s16_pair_case);
    Value* res1 =
        CreateReadU16(m_paired_load, builder->CreateAdd(args[3], builder->getInt32(2)), true);
    res1 = builder->CreateSIToFP(res1, builder->getFloatTy());
    res1 = builder->CreateFMul(res1, dequantize_value);
    Value* final_paired_res = builder->CreateInsertElement(final_res, res1, builder->getInt32(1));
    builder->CreateBr(ending_block);
...
Value* LLVMModule::CreatePairedLoad(LLVMFunction* func, Value* paired, Value* type, Value* scale,
                                    Value* address)
{
  IRBuilder<>* builder = func->GetBuilder();
